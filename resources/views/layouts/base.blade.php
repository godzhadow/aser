...
<body>
                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-xl-4 col-lg-3 col-5">
                            <div class="logo"><a href="{{ url('/') }}"><img src="/img/logo_aser.png" alt=""></a></div>
                        </div>
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                        <ul class="navbar-nav">
                                            <li class="nav-item {{ Request::is('/') ? 'active' : '' }}">
                                                <a class="nav-link" href="{{ url('/') }}" id="navbarDropdown" role="button"  aria-expanded="false">Home</a>
                                            </li>
                                            <li class="nav-item {{ Request::is('program') ? 'active' : '' }}">
                                                <a class="nav-link" href="{{ url('program') }}" id="navbarDropdown2" role="button"  aria-expanded="false">Our Program</a>
                                            </li>
                                            {{-- <li class="nav-item dropdown">
                                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown2" role="button" data-bs-toggle="dropdown" aria-expanded="false">Our Program</a>
                                            ...
                                            <li class="nav-item {{ Request::is('about') ? 'active' : ''}}">
                                                <a class="nav-link" href="{{ url('about') }}" id="navbarDropdown3" role="button"  aria-expanded="false">About Us</a>
                                            </li>
                                            <li class="nav-item {{ Request::is('schedule') ? 'active' : '' }}">
                                                <a class="nav-link" href="{{ url('schedule') }}" id="navbarDropdown4" role="button"  aria-expanded="false">Our Schedule</a>
                                            </li>
                                            {{-- <li class="nav-item dropdown">
                            ...
                            <div class="right-nav d-flex align-items-center justify-content-end">
                                <div class="right-btn">
                                    <ul class="d-flex align-items-center">
                                        @guest
                                            <li><a href="{{ route('login') }}" class="theme_btn free_btn">{{ __('Login') }}</a></li>
                                        @else
                                            <li>
                                                <a class="nav-link" href="#" id="navbarDropdown5" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                    <div class="profile_photo">
                                                        ...
                                                        <b><h4 class="ms-1">{{ str_limit(Auth::user()->name, $limit=6) }}</h4></b>
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown5">
                                                    <li>
                                                        ...
                                                        @elseif (Auth::user()->jenis_user === 'full paper')
                                                            <a class="dropdown-item" href="{{ url('/fullpaper/dashboard/') }}">
                                                            Dashboard
                                                           </a>
                                                        @else
    ...
    <script src="{{ asset('js/owl.carousel.min.js') }}"></script>s
