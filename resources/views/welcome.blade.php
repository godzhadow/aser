...
@section('content')
    <section class="slider-area pt-100 pt-xs-150 pt-100 pb-xs-35">
        <img class="sl-shape shape_01" src="/img/icon/01.svg" alt="">
        <img class="sl-shape shape_02" src="/img/icon/02.svg" alt="">
        <img class="sl-shape shape_03" src="/img/icon/03.svg" alt="">
        <img class="sl-shape shape_04" src="/img/icon/04.svg" alt="">
        <img class="sl-shape shape_05" src="/img/icon/05.svg" alt="">
        <img class="sl-shape shape_06" src="/img/icon/06.svg" alt="">
        <img class="sl-shape shape_07" src="/img/shape/dot-box-5.svg" alt="">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-6 col-lg-6 order-last order-lg-first">
                        <div class="slider__img__box mb-50 pr-30">
                            <img class="img-one mt-55 pr-70" src="/img/main_banner.png" alt="">
                            {{-- <img class="slide-shape img-two" src="/img/slider/02.png" alt=""> --}}
                            {{-- <img class="slide-shape img-three" src="/img/slider/03.png" alt=""> --}}
                            {{-- <img class="slide-shape img-four" src="/img/shape/dot-box-1.svg" alt=""> --}}
                            {{-- <img class="slide-shape img-five" src="/img/shape/dot-box-2.svg" alt=""> --}}
                            {{-- <img class="slide-shape img-six" src="/img/shape/zigzg-1.svg" alt=""> --}}
                            {{-- <img class="slide-shape img-seven wow fadeInRight animated" data-delay="1.5s" src="/img/icon/dot-plan-1.svg" alt="Chose-img"> --}}
                            {{-- <img class="slide-shape img-eight" src="/img/slider/earth-bg.svg" alt=""> --}}
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 text-center">
                        <div class="slider__content pt-15">
                            <img src="/img/logo_aser.png">
                            <h1 class="main-title mb-40 wow fadeInUp2 animated" data-wow-delay='.1s'>INTERNATIONAL VIRTUAL CONFERENCE</h1>
    ...
    <!--slider-area end-->
    <!--slider-area start-->
    <section class="slider-area slider-three slider-gradient-bg">
        <img class="sl-shape shape_s13" src="img/icon/01.svg" alt="">
        <img class="sl-shape shape_01" src="img/icon/05.svg" alt="">
        <img class="sl-shape shape_02" src="img/icon/02.svg" alt="">
        <img class="sl-shape shape_03" src="img/icon/04.svg" alt="">
        <img class="sl-shape shape_04" src="img/icon/03a.svg" alt="">
        <img class="sl-shape shape_06" src="img/icon/06.svg" alt="">
        ...
        <div class="main-slider">
             <div class="container">
                 <div class="row justify-content-center">
                     <div class="col-lg-10">
                         <div class="slider__content slider__content__03 text-center pt-50 pr-50 pl-50">
                            <h2 class="mb-45 wow fadeInUp2 animated" data-wow-delay='.2s'>Sustaining The Momentum For New World Order Developing the entrepreneurship For socio economic recovery</h2>
                     ...
                     <div class="col-lg-12">
                         <div class="slider-img-area">
                            <div class="slider-img-box-three" style="background-image: url(img/main-page/image1.png);">
    ...
    <!--slider-area end-->
    <!-- why-chose-us start -->
    <section class="why-chose-us chose-round-bg gradient-bg">
        ...
        <div class="container">
            <div class="row align-items-center mb-50">
                <div class="col-xl-5 col-lg-12">
                    <div class="chose-wrapper mb-30">
                        <div class="section-title section-title-3 mb-30 wow fadeInUp2 animated" data-wow-delay='.1s'>
                            ...
                            <h2 class="mb-25">What is <span class="bottom-line">ASER?</span></h2>
                            ...
                            <li>
                                 <div class="single-box s-box-2 mb-30 wow fadeInUp2 animated" data-wow-delay='.2s'>
                                    <div class="single-box__icon mb-25">
                                        <img src="img/icon/skill-level-intermediate.svg" alt="">
                                    </div>
                            ...
                            <li>
                                <div class="single-box s-box-2 mb-30 wow fadeInUp2 animated" data-wow-delay='.3s'>
                                    <div class="single-box__icon icon_02 mb-25">
                                        <img src="img/icon/avatar-outline-alerted.svg" alt="">
                                    </div>
                ...
                <div class="col-xl-7 col-lg-12">
                    <div class="chose-img-wrapper-03 chose-img-full mb-30 pos-rel" style="background-image: url(img/main-page/image2.png);">
        ...
        <section class="why-chose-us pt-50">
                        ...
                        <div class="col-xl-7 col-lg-7">
                            <div class="chose-img-wrapper mb-50 pos-rel">
                                ...
                                <div class="img-bg pos-rel">
                                    <img class="chose_05 pl-60 pl-lg-0 pl-md-0 pl-xs-0" src="img/main-page/image3.png" alt="Chose-img">
                                </div>
    ...
    <section class="great-deal-area pt-150 pb-90 pt-md-100 pb-md-40 pt-xs-100 pb-xs-40">
        ...
        <div class="row pt-50 pl-75 pr-75 pr-lg-0 pr-md-0 pr-xs-0 pl-lg-0 pl-md-0 pl-xs-0">
    ...
    <section class="what-looking-for pos-rel">
        ...
        <div class="what-look-bg gradient-bg pt-145 pt-md-95 pt-xs-95">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="what-box text-center mb-35 wow fadeInUp2 animated" data-wow-delay='.3s'>
                            ...
                            <a href="{{ route('register', ['ref' => 'full paper']) }}" class="theme_btn border_btn">Register Now</a>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="what-box text-center mb-35 wow fadeInUp2 animated" data-wow-delay='.3s'>
                            ...
                            <h3>Non-Research paper</h3>
                            <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed di nonumy eirmod tempor invidunt ut labore et dolore magn aliq erat.</p>
                            <a href="{{ route('register', ['ref' => 'non-full paper']) }}" class="theme_btn border_btn">Register Now</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="what-look-bg gradient-bg pt-145 pb-130 pt-md-95 pb-md-80 pt-xs-95 pb-xs-80">
            <div class="container">
                <div class="categoris-container">
                    ...
                    <div class="row row-cols-1 row-cols-sm-3 row-cols-md-3 row-cols-lg-3 row-cols-xl-5 text-center justify-content-center">

                        <div class="col">
                            <div class="single-category text-center mb-30 wow fadeInUp2 animated" data-wow-delay='.2s'>
                                <img class="mb-10" src="img/main-page/indonesia.png" alt="">
                                <h4 class="sub-title mb-10"><a href="course-details.html">Indonesia</a></h4>
                                <p>325+ Journals Available</p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="single-category text-center mb-30 wow fadeInUp2 animated" data-wow-delay='.3s'>
                                <img class="mb-10" src="img/main-page/philippines.png" alt="">
                                <h4 class="sub-title mb-10"><a href="course-details.html">Philippines</a></h4>
                                <p>95+ Journals Available</p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="single-category text-center mb-30 wow fadeInUp2 animated" data-wow-delay='.4s'>
                                <img class="mb-10" src="img/main-page/australia.png" alt="">
                                <h4 class="sub-title mb-10"><a href="course-details.html">Australia</a></h4>
                                <p>156+ Journals Available</p>
                            </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="instructor-active owl-carousel">
                    <div class="item">
                        <div class="z-instructors text-center mb-30">
                            <div class="z-instructors__thumb mb-15">
                                <img src="img/main-page/profesional_image1.png" alt="">
                    ...
                    <div class="item">
                        <div class="z-instructors text-center mb-30">
                            <div class="z-instructors__thumb mb-15">
                                <img src="img/main-page/profesional_image2.png" alt="">
                                <div class="social-media">
                                    <a href="#"><i class="fab fa-facebook-f"></i></a>
                                    <a href="#"><i class="fab fa-twitter"></i></a>
                                    <a href="#"><i class="fab fa-instagram"></i></a>
                    ...
                    <div class="item">
                        <div class="z-instructors text-center mb-30">
                            <div class="z-instructors__thumb mb-15">
                                <img src="img/main-page/profesional_image3.png" alt="">
                                <div class="social-media">
                                    <a href="#"><i class="fab fa-facebook-f"></i></a>
                                    <a href="#"><i class="fab fa-twitter"></i></a>
                                    <a href="#"><i class="fab fa-instagram"></i></a>
                    ...
                    <div class="item">
                        <div class="z-instructors text-center mb-30">
                            <div class="z-instructors__thumb mb-15">
                                <img src="img/main-page/profesional_image4.png" alt="">
                                <div class="social-media">
                                    <a href="#"><i class="fab fa-facebook-f"></i></a>
                                    <a href="#"><i class="fab fa-twitter"></i></a>
                                    <a href="#"><i class="fab fa-instagram"></i></a>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="z-blogs mb-30 wow fadeInUp2 animated" data-wow-delay='.1s'>
                            ...
                            <a href="blog-details.html"><img src="img/main-page/news_image1.png" alt="blog-img"></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="z-blogs mb-30 wow fadeInUp2 animated" data-wow-delay='.3s'>
                            <div class="z-blogs__thumb mb-30">
                            <a href="blog-details.html"><img src="img/main-page/news_image3.png" alt="blog-img"></a>
                            </div>
                            <div class="z-blogs__content">
    ...
    <section>
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="section-title text-center mt-30 mb-60">
                        <h2 class="mb-25">MILESTONE</h2>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                    ...
                    <div class="timeline">
                        <div class="container-timeline right">
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="col-md-6">
                                        <img src="img/main-page/milestone_image1.png">
                                    </div>
                        ...
                        <div class="container-timeline right">
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="col-md-6">
                                        <img src="img/main-page/milestone_image2.png">
                                    </div>
                                    <div class="col-md-6 align-self-center">
                                        <p>
                                            Lorem ipsum dolor sit amet elit. Aliquam odio dolor, id luctus erat sagittis non. Ut blandit semper pretium.
                        ...
                        <div class="container-timeline right">
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="col-md-6">
                                        <img src="img/main-page/milestone_image3.png">
                                    </div>
                                    <div class="col-md-6 align-self-center">
                                        <p>
                                            Lorem ipsum dolor sit amet elit. Aliquam odio dolor, id luctus erat sagittis non. Ut blandit semper pretium.
                        ...
                        <div class="container-timeline right">
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="col-md-6">
                                        <img src="img/main-page/milestone_image4.png">
                                    </div>
                                    <div class="col-md-6 align-self-center">
                                        <p>
                                            Lorem ipsum dolor sit amet elit. Aliquam odio dolor, id luctus erat sagittis non. Ut blandit semper pretium.
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="faq-img-wrapper pos-rel mb-30">
                        <img class="faq_01" src="img/main-page/question_image.png" alt="">
