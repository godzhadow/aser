                ...
                <div class="col-md-11">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $user->team; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                    ...
                    <div class="row mt-50">
                        <div class="col-md-12 text-end">
                            <a href="<?php echo e(url('/fullpaper/dashboard/paper')); ?>" class="btn btn-primary col-md-6 p-3">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group mb-3">
                            ...
                            <div class="form-text">enter name here for <?php if($user->team->count() < 1): ?> second
                            <?php elseif( $user->team->count()==1): ?> third
                            <?php elseif($user->team->count()==2): ?> fourth
                            <?php elseif($user->team->count()==3): ?> fifth
                            <?php elseif($user->team->count()==4): ?> sixth
                            <?php else: ?> seven
